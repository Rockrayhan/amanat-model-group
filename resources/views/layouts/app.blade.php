        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="/" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"> GoClova</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('home') }}" class="nav-item nav-link {{ Route::is('home') ? 'active' : '' }}"><i
                    ...
                    <a href="{{ route('casestudy.index') }}"
                        class="nav-item nav-link {{ Route::is('casestudy.index') ? 'active' : '' }}"><i
                            class="fa fa-keyboard me-2"></i>Case-Studies</a>

                    <a href="{{ route('api-lists') }}"
                        class="nav-item nav-link {{ Route::is('api-lists') ? 'active' : '' }}"><i
                            class="fa fa-keyboard me-2"></i> API </a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="{{ route('admin.change.password.form') }}" class="dropdown-item">Change Password</a>
                            <a href="{{ route('admin.logout') }}" class="dropdown-item"
                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                Log Out
                            </a>
                            <form id="logout-form" action="{{ route('admin.logout') }}" method="GET" class="d-none"></form>
                        </div>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row container">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a target="_blank" href="https://www.goclova.com/">GoClova</a>, All Right Reserved.
                        </div>
