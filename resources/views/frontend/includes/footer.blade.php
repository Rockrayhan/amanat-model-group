  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
      ...
      <div class="space-y-5">
        <div class="flex flex-col gap-3">
          ...
          {{-- <img src="{{ asset('/frontend/images/logo.png') }}" alt="AMANAT MODEL GROUP" class="h-32 w-full"> --}}
          <span class="text-2xl font-bold text-white">AMANAT MODEL GROUP</span>
        </div>
        <p class="text-gray-400">
          Transforming industries through innovation and sustainable business practices.
        </p>
      ...
      <div>
        ...
        <address class="not-italic space-y-2">
          <div class="flex items-start">
            <svg class="h-5 w-5 mt-0.5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
            </svg>
            <span class="text-gray-400">123 Business Avenue, City, Country</span>
          </div>
          ...
          <div class="flex items-center">
            ...
            <span class="text-gray-400">info@amanatmodelgroup.com</span>
          </div>
        </address>
      </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-center">
      ...
      <div class="flex space-x-6">
        ...
        <a href="#" class="text-gray-300 hover:text-white text-sm transition-colors">Sitemap</a>
      </div>
    </div>
  </div>
</div>